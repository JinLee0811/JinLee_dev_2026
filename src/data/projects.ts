...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    description: "A web-focused freelance business homepage built for client inquiries and service showcase.",
    overview: "Built as a business website to present web freelance services and streamline inbound inquiries.",
    date: "01 Feb 2026",
    category: "Personal",
    ...
    features: [
      "Business-focused landing and service sections",
      "Client inquiry flow for freelance web projects",
      "Responsive UI optimised for desktop and mobile",
    ],
    techStack: ["Next.js", "TypeScript", "Tailwind CSS", "Vercel"],
    apis: ["Email/contact workflow integration"],
    challenges: [
      "Designing clear service messaging for conversion",
      "Balancing branding, performance, and responsiveness",
    ],
    takeaways: [
      "Clear value proposition improves inquiry quality",
      "Fast, polished UX increases business trust",
    ],
  },
  {
    id: 15,
