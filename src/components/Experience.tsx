...
const experiences: ExperienceItem[] = [
  {
    id: 1,
    company: "TPZ, Seoul (Hybrid)",
    position: "Software Engineer (Full-stack Developer)",
    period: "Dec 2022 – Nov 2023",
    description: [
      "Worked as a full-stack developer with a balanced contribution: 50% frontend and 50% backend",
      "Built and maintained web product features across UI, APIs, and data flows in a hybrid team environment",
      "Delivered production-ready functionality from requirements through deployment and iteration",
    ],
    skills: ["React", "TypeScript", "Node.js", "REST APIs", "Full-stack Development"],
  },
  {
    id: 2,
    ...
    description: [
      ...
      "Contributed to scalable frontend architecture for ongoing feature delivery",
    ],
    skills: ["React", "JavaScript", "Component Architecture", "Frontend Performance"],
  },
  {
    id: 3,
    company: "Youniv, Seoul",
    ...
    description: [
      ...
      "Established a design-to-code workflow that reduced engineering friction",
      "Led the initial company web asset build from visual identity to domain setup and cloud onboarding",
      "Optimized 4K and high-resolution media assets for web delivery, balancing quality, speed, and storage cost",
    ],
    skills: ["UI/UX Design", "Figma", "Adobe CC", "Web Production", "Content Optimization"],
  },
];
